...
<link href="front/plugins/flexslider/flexslider.css" rel="stylesheet" media="screen" />
<link href="front/css/cubeportfolio.min.css" rel="stylesheet" />
<link href="front/css/style.css" rel="stylesheet" />
<link id="t-colors" href="front/skins/default.css" rel="stylesheet" />
...
<div id="wrapper">
        ...
        <div class="navbar navbar-default navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="front/index.html"><img src="front/img/castalia.png" alt="" width="100" height="52" /></a>
                </div>
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                        <li class="dropdown active">
						   ...
						   <li class="dropdown active">
							<a href="front/#" class="btn ubutia-btn" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Admin</a>
                           </li>
	...
	<!-- Slider -->
        <div id="main-slider" class="main-slider flexslider">
            <ul class="slides">
              <li>
                <img src="front/img/slides/flexslider/1.jpg" alt="" />
              ...
              <li>
                <img src="front/img/slides/flexslider/2.jpg" alt="" />
                <div class="flex-caption">
              ...
              <li>
                <img src="front/img/slides/flexslider/4.jpg" alt="" />
                <div class="flex-caption">
...
<a href="front/#" class="scrollup"><i class="fa fa-angle-up active"></i></a>
...
<script src="front/plugins/flexslider/jquery.flexslider-min.js"></script>
<script src="front/plugins/flexslider/flexslider.config.js"></script>
