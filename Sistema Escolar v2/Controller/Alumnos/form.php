							...
							<form role="form" method="POST" action="agregar.php" enctype="multipart/form-data">
                               <?php if(isset($id)){ echo "<input type='hidden' value='$fila->idalumnos' name='id'>"; }?>
								...
								<div class="form-group">
									...
									<input type="text" id="reuno" name="fechan" class="form-control" required value="<?php  if(isset($id)){echo  $fila->fechanacimiento;} ?>">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<input type="text" id="redos" name="fecha" class="form-control" required value="<?php  if(isset($id)){echo  $fila->fecharegistro;} ?>">
								</div>
								<div class="form-group">
